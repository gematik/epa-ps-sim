...
import de.gematik.epa.api.testdriver.impl.SignatureApiImpl;
 ...
 * SignatureApiImpl} implementation.<br>
 * It is autoconfigured through the cxf-spring-boot-starter-jaxrs, so no manual setup is required
 */
@Service
public final class SignatureApiEndpoint extends SignatureApiImpl {

  public SignatureApiEndpoint(
