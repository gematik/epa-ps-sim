...
import de.gematik.epa.api.testdriver.impl.CardApiImpl;
...
@Service
public class CardApiEndpoint extends CardApiImpl {

  public CardApiEndpoint(
      final SmbInformationProvider smbInformationProvider,
      final HbaInformationProvider hbaInformationProvider,
