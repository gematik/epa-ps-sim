...
class EntitlementApiEndpointV1IntegrationTest extends AbstractIntegrationTest {
  ...
  void shouldSetEntitlement() {
    ...
    var response = entitlementApiEndpointV1.postEntitlement(KVNR, request);
  ...
  void getBlockedUsersShouldReturnSuccessFor200Response() {
    ...
    GetBlockedUserListResponseDTO response = entitlementApiEndpointV1.getBlockedUserList(KVNR);
  ...
  void setBlockedUsersShouldReturnSuccessFor201Response() {
    ...
    ResponseDTO response = entitlementApiEndpointV1.postBlockedUser(KVNR, requestDTO);
    assertThat(response.getSuccess()).isTrue();
  }
  ...
  void deleteBlockedUsersShouldReturnSuccessFor204Response() {
    ...
    ResponseDTO response = entitlementApiEndpointV1.deleteBlockedUser(KVNR, SMB_AUT_TELEMATIK_ID);
    assertThat(response.getSuccess()).isTrue();
