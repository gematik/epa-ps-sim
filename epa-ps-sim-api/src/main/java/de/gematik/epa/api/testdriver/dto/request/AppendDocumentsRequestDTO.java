...
@Schema(description = "Request um Dokumente in einem Aktenkonto zu anhängen")
public record AppendDocumentsRequestDTO(
    @JsonProperty(required = true) @Schema(description = KVNR_DESCRIPTION) String kvnr,
    @JsonProperty(required = true)
        @Schema(
            description =
                "Liste von Dokumenten, den zugehörigen Metadaten und der entryUUID des jeweils zu anhängenden Dokuments")
        List<AppendDocument> documentSets) {}
