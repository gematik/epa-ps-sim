...
import de.gematik.epa.api.testdriver.poppToken.PoppTokenGeneratorApi;
...
public class PoppTokenGeneratorImpl implements PoppTokenGeneratorApi {

  private final PoppTokenGeneratorService service;

  @Override
  public PoppTokenResponseDto tokenFromGenerator(TokenRequest request) {
