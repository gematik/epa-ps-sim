...
import de.gematik.epa.api.testdriver.poppToken.PoppTokenReferenceApi;
...
public class PoppTokenApiImpl implements PoppTokenReferenceApi {

  private final PoppTokenService poppTokenService;

  @Override
  public GetPoppTokenResponseDto generateToken(TokenGenerationParams tokenGenerationParams) {
    return poppTokenService.generateToken(tokenGenerationParams);
  }
}
