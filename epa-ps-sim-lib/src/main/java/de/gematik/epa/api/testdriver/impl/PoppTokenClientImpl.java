...
import de.gematik.epa.api.testdriver.poppToken.PoppTokenClientApi;
...
public class PoppTokenClientImpl implements PoppTokenClientApi {

  private final PoppTokenClientService service;

  @Override
  public PoppTokenResponseDto tokenFromClient(PoppClientRequestDto request) {
