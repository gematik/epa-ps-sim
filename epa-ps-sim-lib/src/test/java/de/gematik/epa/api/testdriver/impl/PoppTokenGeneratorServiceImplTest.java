...
class PoppTokenGeneratorServiceImplTest {
  private final PoppTokenGeneratorService service = mock(PoppTokenGeneratorService.class);

  @Test
  void generateToken() {
    var tokenGenerationParams = mock(TokenRequest.class);
    var tokenParams = mock(TokenParams.class);
    var mockResponse = mock(PoppTokenResponseDto.class);
