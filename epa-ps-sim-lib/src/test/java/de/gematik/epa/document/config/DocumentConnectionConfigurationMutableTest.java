...
class DocumentConnectionConfigurationMutableTest {

  @Test
  void update() {
    var tstData =
        TestDataFactory.createDocumentConnectionConfiguration()
            .address(new AddressConfig("localhost", 433, "http", "xds"));
    var tstObj = TestDataFactory.createDocumentConnectionConfiguration();
